...
#♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥اي♥♥♥♥♥♥♥♥♥♥
@sython1.on(events.NewMessage(outgoing=True, pattern=r"\.تفليش"))
async def _(event):
    await event.delete()
...
@sython1.on(events.NewMessage(outgoing=True, pattern=r"\.اكس او"))
async def _(event):
    bot = 'inlinegamesbot'
...
@sython1.on(events.NewMessage(outgoing=True, pattern=r"\.قلب"))
async def _(event):
...
@sython1.on(events.NewMessage(outgoing=True, pattern=r"\.مربعات"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sython1.on(events.NewMessage(outgoing=True, pattern=r"\.ورود"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sython1.on(events.NewMessage(outgoing=True, pattern=r"\.سيشن"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sython1.on(events.NewMessage(outgoing=True, pattern=r"\.رابط السورس"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
